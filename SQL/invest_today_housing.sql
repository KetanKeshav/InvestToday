...
INSERT INTO `housing` VALUES ('jbnj','jbj','bjb','jbjb'),('fff','ffff','fff','fff'),('erwerrrtr','efrgerg','greger','qqqqq'),('kkkk','lkljl','kjjkh','jkhjk'),('jkjkl','hjhk','hghj','nnnnnnnnnnnnnnnn'),('test','test','test','test');
